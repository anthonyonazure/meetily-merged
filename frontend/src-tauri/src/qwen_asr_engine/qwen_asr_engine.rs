...
// PROVENANCE NOTE: these GGUF weights are hosted in a community Hugging Face
// account (FlippyDora), not an official Qwen/Alibaba release. Downloads are
// size- and magic-number-validated, but treat the artifacts as community
