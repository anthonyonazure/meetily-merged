...
impl<R: Runtime> NotificationManager<R> {
    ...
    async fn should_show_notification(&self, notification: &Notification) -> bool {
        ...
        match &notification.notification_type {
            ...
            NotificationType::MeetingDetected(_) => {
                settings.notification_preferences.show_meeting_detected
            }
            NotificationType::MeetingEnded(_) => {
                settings.notification_preferences.show_meeting_ended
            }
        }
    }
