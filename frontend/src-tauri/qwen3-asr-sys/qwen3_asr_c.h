...
// Returns false for stub builds (no vendor library); stub transcription
// output is placeholder text and must never be surfaced to users.
bool qwen3_asr_is_available(void);
