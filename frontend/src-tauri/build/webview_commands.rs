...
///
/// Keep this list in lockstep with `permissions/main-window.toml` and the
...
pub const WEBVIEW_COMMANDS: &[&str] = &[
    ...
    "billing_export",
    "billing_report",
    "billing_settings_get",
    "billing_settings_set",
    "branding_clear_logo",
    "branding_get",
    "branding_pick_logo",
    "branding_preview",
    ...
    "check_screen_recording_permission_command",
    "check_system_audio_permissions_command",
    "cleanup_checkpoints",
    "clear_notifications",
    "client_billing_get",
    "client_billing_set",
    ...
    "client_set_privacy_profile",
    "client_timeline",
    "client_update",
    "clients_list",
    "complete_onboarding",
    "consent_active_session",
    "consent_bind_meeting",
    "consent_get_settings",
    "consent_grant_clearance",
    "consent_log_export",
    "consent_log_for_meeting",
    "consent_prefill_attendees",
    "consent_prepare_recording",
    "consent_record_event",
    "consent_redaction_state",
    "consent_save_settings",
    "consent_speak_announcement",
    "consent_speakers_for_meeting",
    "debug_backend_connection",
    "debug_check_update",
    "debug_show_notification",
    "delete_ollama_model",
    "detect_legacy_database",
    "diarization_download_models",
    "diarization_get_model_info",
    "diarization_get_settings",
    "diarization_is_ready",
    "diarization_set_enabled",
    "dictation_check_accessibility",
    "dictation_check_input_monitoring",
    "dictation_get_hotkey",
    "dictation_get_last_transcript",
    "dictation_paste_last_transcript",
    "dictation_request_accessibility",
    "dictation_request_input_monitoring",
    "dictation_restart_listener",
    "dictation_set_hotkey",
    "dictation_start_manual",
    "dictation_stop_manual",
    "dismiss_detected_meeting",
    "embeddings_index_status",
    "embeddings_reindex",
    "embeddings_settings_get",
    "embeddings_settings_set",
    "export_meetings",
    ...
    "m365_auth_status",
    "m365_begin_device_login",
    "m365_cancel_device_login",
    "m365_create_summary_draft",
    "m365_disconnect",
    "m365_get_config",
    "m365_set_config",
    ...
    "meeting_get_client",
    "meeting_privacy_profile",
    "meeting_set_client",
    "meeting_suggest_client",
    "meeting_type_clear",
    "meeting_type_detect",
    "meeting_type_get",
    "meeting_type_mappings_get",
    "meeting_type_mappings_set",
    "meeting_type_set",
    "memory_fact_delete",
    "memory_fact_set_status",
    "memory_facts_for_client",
    "memory_facts_for_meeting",
    "memory_search",
    "memory_stale_open_count",
    "network_events_export",
    "network_events_for_meeting",
    "network_events_recent",
    "network_expected_hosts",
    ...
    "pause_parallel_processing",
    "pause_recording",
    "poll_audio_device_events",
    "prepare_audio_chunks",
    "privacy_profile_create",
    "privacy_profile_delete",
    "privacy_profile_update",
    "privacy_profile_usage",
    "privacy_profiles_list",
    "privacy_redaction_preview",
    "privacy_settings_get",
    "privacy_settings_set_default",
    "pull_ollama_model",
    "qwen_asr_cancel_download",
    "qwen_asr_delete_model",
    "qwen_asr_download_model",
    "qwen_asr_get_available_models",
    "qwen_asr_get_current_model",
    "qwen_asr_get_models_directory",
    "qwen_asr_has_available_models",
    "qwen_asr_init",
    "qwen_asr_is_available",
    "qwen_asr_is_model_loaded",
    "qwen_asr_load_model",
    "qwen_asr_open_models_folder",
    "qwen_asr_transcribe_audio",
    "qwen_asr_validate_model_ready",
    "read_audio_file",
    "recover_audio_from_checkpoints",
    "request_notification_permission",
    "request_screen_recording_permission_command",
    "reset_onboarding_status_cmd",
    "resume_parallel_processing",
    "resume_recording",
    "retention_preview",
    "retention_run_now",
    "retention_settings_get",
    "retention_settings_set",
    ...
    "set_manual_dnd",
    "set_notification_consent",
    "set_notification_settings",
    "set_process_detection_enabled",
    ...
    "start_system_audio_capture_command",
    ...
    "test_notification_with_auto_consent",
    "test_parallel_processing_setup",
    "toggle_console",
