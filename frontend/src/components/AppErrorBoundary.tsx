    ...
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-surface p-8">
        <div className="max-w-2xl">
          ...
          <pre className="max-h-80 overflow-auto whitespace-pre-wrap rounded-md bg-wash p-4 text-xs text-red-700">
            {error.message}
            {'\n\n'}
            {error.stack}
          </pre>
          <button
            ...
            className="mt-4 rounded-md border border-edge px-3 py-2 text-sm hover:bg-wash"
          >
            Try again
          </button>
        </div>
