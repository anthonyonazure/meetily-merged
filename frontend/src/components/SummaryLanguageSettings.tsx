...
export function SummaryLanguageSettings() {
  ...
  return (
    <div className="bg-surface rounded-lg border border-edge p-6 shadow-sm relative">
          ...
          return (
            ...
            >
              ...
              >
                <Pin
                  size={14}
                  className={isPinned ? 'text-blue-600' : 'text-faint'}
              ...
              <button
                ...
                className={`pr-2.5 pl-0.5 py-1 leading-none ${isPinned ? 'text-blue-400 hover:text-blue-700' : 'text-faint hover:text-muted-ink'}`}
              >
                ×
              </button>
            </span>
        ...
        <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
          <PopoverTrigger asChild>
            <button
              ...
              className="inline-flex items-center gap-1 rounded-full border border-dashed border-edge px-3 py-1 text-sm text-muted-ink hover:border-faint hover:text-ink disabled:cursor-not-allowed disabled:opacity-50"
            >
              ＋ Add language
            </button>
          </PopoverTrigger>
