        ...
        <div className="flex items-start justify-between mb-2">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 flex-wrap mb-2">
              ...
              <span className="text-sm text-muted-ink">{getModelTagline(model.name, model.speed, model.accuracy)}</span>
              {isSelected && isAvailable && (
                <motion.span
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
            ...
            {/* Model Specs */}
            <div className="flex items-center space-x-4 text-sm text-muted-ink ml-9 mt-1.5">
