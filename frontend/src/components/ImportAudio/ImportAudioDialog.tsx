            ...
            <>
              {fileInfo ? (
                <div className="bg-app rounded-lg p-4 space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-sm text-muted-ink mt-1">
                  ...
                  <div className="space-y-1">
                    <label className="text-sm font-medium text-muted-ink">Meeting Title</label>
                    <Input
                      value={title}
                      onChange={(e) => {
                ...
                <div className="border-2 border-dashed border-edge rounded-lg p-8 text-center">
                  <FileAudio className="h-12 w-12 text-faint mx-auto mb-4" />
                  ...
                  <p className="text-sm text-muted-ink mt-2">MP4, WAV, MP3, FLAC, OGG, MKV, WebM, WMA</p>
                </div>
              )}
              ...
              {fileInfo && (
                <div className="border rounded-lg">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 text-sm font-medium text-muted-ink hover:bg-wash"
                  >
          ...
          {isProcessing && progress && (
            <div className="space-y-2">
              <div className="relative">
                <div className="w-full bg-active rounded-full h-3">
                  <div
                    className="bg-blue-600 h-3 rounded-full transition-all duration-300 ease-out"
                    style={{ width: `${Math.min(progress.progress_percentage, 100)}%` }}
                  />
                </div>
                <div className="flex justify-between text-xs text-muted-ink mt-1">
