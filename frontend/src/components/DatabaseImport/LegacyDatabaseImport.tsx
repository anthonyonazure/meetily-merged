        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-faint disabled:cursor-not-allowed transition-colors"
            >
          ...
          <div className="flex flex-col gap-3 pt-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-edge disabled:cursor-not-allowed transition-colors"
            >
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-surface text-muted-ink">or</span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-4 py-3 border-2 border-edge text-muted-ink rounded-lg hover:bg-wash disabled:bg-wash disabled:cursor-not-allowed transition-colors"
            >
