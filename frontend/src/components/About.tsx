    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="text-center">
                ...
                <span className="text-sm text-muted-ink"> v{currentVersion}</span>
                <p className="text-medium text-muted-ink mt-1">
            ...
            <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                    <div className="bg-app rounded p-3 hover:bg-wash transition-colors">
                        <h3 className="font-bold text-sm text-ink mb-1">Privacy-first</h3>
                        <p className="text-xs text-muted-ink leading-relaxed">Your data & AI processing workflow can now stay within your premise. No cloud, no leaks.</p>
                    </div>
                    <div className="bg-app rounded p-3 hover:bg-wash transition-colors">
                        <h3 className="font-bold text-sm text-ink mb-1">Use Any Model</h3>
                        <p className="text-xs text-muted-ink leading-relaxed">Prefer local open-source model? Great. Want to plug in an external API? Also fine. No lock-in.</p>
                    </div>
                    <div className="bg-app rounded p-3 hover:bg-wash transition-colors">
                        <h3 className="font-bold text-sm text-ink mb-1">Cost-Smart</h3>
                        <p className="text-xs text-muted-ink leading-relaxed">Avoid pay-per-minute bills by running models locally (or pay only for the calls you choose).</p>
                    </div>
                    <div className="bg-app rounded p-3 hover:bg-wash transition-colors">
                        <h3 className="font-bold text-sm text-ink mb-1">Works everywhere</h3>
                        <p className="text-xs text-muted-ink leading-relaxed">Google Meet, Zoom, Teams-online or offline.</p>
                    </div>
                </div>
            </div>
            ...
            {/* Footer - Compact */}
            <div className="pt-2 border-t border-edge text-center">
