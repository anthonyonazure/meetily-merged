    ...
    return (
      <div className="p-4 space-y-4">
        <div className="animate-pulse">
          <div className="h-4 bg-active rounded w-1/3 mb-4"></div>
          <div className="h-10 bg-active rounded mb-3"></div>
          <div className="h-10 bg-active rounded"></div>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="h-8 w-8 p-0 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-wash disabled:pointer-events-none disabled:opacity-50"
          >
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="mic-selection" className="text-sm font-medium text-muted-ink">
              Microphone
            </Label>
          </div>
          <Select
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Speaker className="h-4 w-4 text-muted-ink" />
            <Label htmlFor="system-selection" className="text-sm font-medium text-muted-ink">
              System Audio
            </Label>
          </div>
          ...
          {outputDevices.length === 0 && (
            <p className="text-xs text-muted-ink">No system audio devices found</p>
          )}
