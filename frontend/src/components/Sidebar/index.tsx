          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`relative p-2 rounded-lg transition-colors duration-150 ${pathname === '/clients' ? 'bg-active' : 'hover:bg-active/60'
                  }`}
              >
          ...
          {item.type === 'folder' ? (
            <>
              ...
              <div className="ml-auto">
                {isExpanded ? (
                  <ChevronDown className="w-4 h-4 text-muted-ink" />
                ) : (
                  <ChevronRight className="w-4 h-4 text-muted-ink" />
                )}
              </div>
  ...
  return (
    <div className="fixed top-0 left-0 h-screen z-40">
      ...
      <button
        ...
        className="absolute -right-6 top-20 z-50 p-1 bg-surface hover:bg-wash rounded-full shadow-lg border"
      ...
      >
        ...
        <div className="flex-shrink-0 h-22 flex items-center">
          ...
          <div className="flex-1">
            {!isCollapsed && (
              <div className="p-3">
                {/* <span className="text-lg text-center border rounded-full bg-blue-50 border-white font-semibold text-muted-ink mb-2 block items-center">
                  <span>Meetily</span>
                </span> */}
                <Logo isCollapsed={isCollapsed} />
              ...
              <div className="flex-shrink-0">
                {filteredSidebarItems.filter(item => item.type === 'folder').map(item => (
                  <div key={item.id}>
                    ...
                    >
                      <NotebookPen className="w-4 h-4 mr-2 text-muted-ink" />
                      <span className="text-muted-ink">{item.title}</span>
                      {searchQuery && item.id === 'meetings' && isSearching && (
                        <span className="ml-2 text-xs text-blue-500 animate-pulse">Searching...</span>
                      )}
                    </div>
        ...
        {!isCollapsed && (
          ...
          <div className="flex-shrink-0 p-2 border-t border-edge">
            <button
              onClick={handleRecordingToggle}
              disabled={isRecording}
            ...
            {betaFeatures.importAndRetranscribe && (
              <button
                onClick={() => openImportDialog()}
                className="w-full flex items-center justify-center px-3 py-2 mt-1 text-sm font-medium text-muted-ink bg-blue-100 hover:bg-blue-200 rounded-lg transition-colors shadow-sm"
              >
            ...
            <button
              onClick={() => router.push('/settings')}
              className="w-full flex items-center justify-center px-3 py-1.5 mt-1 mb-1 text-sm font-medium text-muted-ink bg-active hover:bg-edge rounded-lg transition-colors shadow-sm"
            >
              <Settings className="w-4 h-4 mr-2" />
              <span>Settings</span>
            </button>
            <Info isCollapsed={isCollapsed} />
            <div className="w-full flex items-center justify-center px-3 py-1 text-xs text-faint">
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="py-4">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="meeting-title" className="block text-sm font-medium text-muted-ink mb-2">
                  Meeting Title
                </label>
                <input
                  id="meeting-title"
                  ...
                  className="w-full px-3 py-2 border border-edge rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <DialogFooter>
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-muted-ink bg-wash hover:bg-active rounded-md transition-colors"
            >
              Cancel
            </button>
            <button
