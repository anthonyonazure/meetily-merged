...
export function OnboardingContainer({
  ...
  return (
    <div className="fixed inset-0 bg-app flex items-center justify-center z-50 overflow-hidden">
            ...
            {showNavigation && (
              <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 flex justify-between pointer-events-none">
                <button
                  ...
                  className={cn(
                    'pointer-events-auto w-8 h-8 rounded-full bg-surface border border-edge shadow-sm flex items-center justify-center transition-all duration-200',
                    canGoPrevious && step !== 1
                      ? 'hover:bg-wash hover:shadow-md hover:scale-110 text-muted-ink'
