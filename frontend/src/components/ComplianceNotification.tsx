...
export const ComplianceNotification: React.FC<ComplianceNotificationProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-surface border border-edge rounded-lg shadow-lg p-3">
        ...
        <div className="flex items-start justify-between mb-2">
          ...
          <button
            onClick={handleClose}
            className="text-faint hover:text-muted-ink transition-colors p-0.5 rounded hover:bg-wash"
          >
            <X className="h-3 w-3" />
          </button>
        </div>
