...
export function TranscriptPanel({
  ...
  return (
    <div ref={transcriptContainerRef} className="w-full border-r border-edge bg-surface flex flex-col overflow-y-auto">
      {/* Title area - Sticky header */}
      <div className="sticky top-0 z-10 bg-surface p-4 border-edge">
